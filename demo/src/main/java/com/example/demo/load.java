...
public class load extends AppCompatActivity {
    ...
    private void init() {
        ...
        tv_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //为了跳转到注册界面，并实现注册功能
                Toast.makeText(load.this, "请输入密码", Toast.LENGTH_SHORT).show();
        ...
        tv_find_psw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //跳转到找回密码界面（此页面暂未创建）
                Toast.makeText(load.this, "开发中", Toast.LENGTH_SHORT).show();
            }
        });
        //登录按钮的点击事件
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userName)){
                    Toast.makeText(load.this, "请输入用户名", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    Toast.makeText(load.this, "输入的用户名和密码不一致", Toast.LENGTH_SHORT).show();
                    return;
                }else{
                    Toast.makeText(load.this, "此用户名不存在", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
